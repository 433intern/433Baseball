...
// optional int32 winCnt = 5;
inline bool LSC_login_result::has_wincnt() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void LSC_login_result::set_has_wincnt() {
  _has_bits_[0] |= 0x00000010u;
}
inline void LSC_login_result::clear_has_wincnt() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void LSC_login_result::clear_wincnt() {
  wincnt_ = 0;
  clear_has_wincnt();
}
inline ::google::protobuf::int32 LSC_login_result::wincnt() const {
  // @@protoc_insertion_point(field_get:protocol.LSC_login_result.winCnt)
  return wincnt_;
}
inline void LSC_login_result::set_wincnt(::google::protobuf::int32 value) {
  set_has_wincnt();
  wincnt_ = value;
  // @@protoc_insertion_point(field_set:protocol.LSC_login_result.winCnt)
}

// optional int32 loseCnt = 6;
inline bool LSC_login_result::has_losecnt() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void LSC_login_result::set_has_losecnt() {
  _has_bits_[0] |= 0x00000020u;
}
inline void LSC_login_result::clear_has_losecnt() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void LSC_login_result::clear_losecnt() {
  losecnt_ = 0;
  clear_has_losecnt();
}
inline ::google::protobuf::int32 LSC_login_result::losecnt() const {
  // @@protoc_insertion_point(field_get:protocol.LSC_login_result.loseCnt)
  return losecnt_;
}
inline void LSC_login_result::set_losecnt(::google::protobuf::int32 value) {
  set_has_losecnt();
  losecnt_ = value;
  // @@protoc_insertion_point(field_set:protocol.LSC_login_result.loseCnt)
}
