...
class SC_room_info_response : public ::google::protobuf::Message {
 public:
  SC_room_info_response();
  virtual ~SC_room_info_response();

  SC_room_info_response(const SC_room_info_response& from);

  inline SC_room_info_response& operator=(const SC_room_info_response& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SC_room_info_response& default_instance();

  void Swap(SC_room_info_response* other);

  // implements Message ----------------------------------------------

  SC_room_info_response* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SC_room_info_response& from);
  void MergeFrom(const SC_room_info_response& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static SC_room_info_response* default_instance_;
};
// -------------------------------------------------------------------
...
// optional uint32 roomCount = 1;
inline bool SC_room_info_response::has_roomcount() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void SC_room_info_response::set_has_roomcount() {
  _has_bits_[0] |= 0x00000001u;
}
inline void SC_room_info_response::clear_has_roomcount() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void SC_room_info_response::clear_roomcount() {
  roomcount_ = 0u;
  clear_has_roomcount();
}
inline ::google::protobuf::uint32 SC_room_info_response::roomcount() const {
  // @@protoc_insertion_point(field_get:protocol.SC_room_info_response.roomCount)
  return roomcount_;
}
inline void SC_room_info_response::set_roomcount(::google::protobuf::uint32 value) {
  set_has_roomcount();
  roomcount_ = value;
  // @@protoc_insertion_point(field_set:protocol.SC_room_info_response.roomCount)
}

// repeated .protocol.RoomInfo roomList = 2;
inline int SC_room_info_response::roomlist_size() const {
  return roomlist_.size();
}
inline void SC_room_info_response::clear_roomlist() {
  roomlist_.Clear();
}
inline const ::protocol::RoomInfo& SC_room_info_response::roomlist(int index) const {
  // @@protoc_insertion_point(field_get:protocol.SC_room_info_response.roomList)
  return roomlist_.Get(index);
}
inline ::protocol::RoomInfo* SC_room_info_response::mutable_roomlist(int index) {
  // @@protoc_insertion_point(field_mutable:protocol.SC_room_info_response.roomList)
  return roomlist_.Mutable(index);
}
inline ::protocol::RoomInfo* SC_room_info_response::add_roomlist() {
  // @@protoc_insertion_point(field_add:protocol.SC_room_info_response.roomList)
  return roomlist_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::protocol::RoomInfo >&
SC_room_info_response::roomlist() const {
  // @@protoc_insertion_point(field_list:protocol.SC_room_info_response.roomList)
  return roomlist_;
}
inline ::google::protobuf::RepeatedPtrField< ::protocol::RoomInfo >*
SC_room_info_response::mutable_roomlist() {
  // @@protoc_insertion_point(field_mutable_list:protocol.SC_room_info_response.roomList)
  return &roomlist_;
}
