...
// optional uint32 roomNum = 2;
inline bool SC_room_create_result::has_roomnum() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void SC_room_create_result::set_has_roomnum() {
  _has_bits_[0] |= 0x00000002u;
}
inline void SC_room_create_result::clear_has_roomnum() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void SC_room_create_result::clear_roomnum() {
  roomnum_ = 0u;
  clear_has_roomnum();
}
inline ::google::protobuf::uint32 SC_room_create_result::roomnum() const {
  // @@protoc_insertion_point(field_get:protocol.SC_room_create_result.roomNum)
  return roomnum_;
}
inline void SC_room_create_result::set_roomnum(::google::protobuf::uint32 value) {
  set_has_roomnum();
  roomnum_ = value;
  // @@protoc_insertion_point(field_set:protocol.SC_room_create_result.roomNum)
}
...
// optional uint32 roomNum = 2;
inline bool SC_room_join_result::has_roomnum() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void SC_room_join_result::set_has_roomnum() {
  _has_bits_[0] |= 0x00000002u;
}
inline void SC_room_join_result::clear_has_roomnum() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void SC_room_join_result::clear_roomnum() {
  roomnum_ = 0u;
  clear_has_roomnum();
}
inline ::google::protobuf::uint32 SC_room_join_result::roomnum() const {
  // @@protoc_insertion_point(field_get:protocol.SC_room_join_result.roomNum)
  return roomnum_;
}
inline void SC_room_join_result::set_roomnum(::google::protobuf::uint32 value) {
  set_has_roomnum();
  roomnum_ = value;
  // @@protoc_insertion_point(field_set:protocol.SC_room_join_result.roomNum)
}
